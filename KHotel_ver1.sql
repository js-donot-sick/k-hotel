...
CREATE USER semi_khj IDENTIFIED BY khotel1234;

ALTER USER semi_khj DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;

GRANT CONNECT, RESOURCE, CREATE VIEW TO semi_khj;


--2023-08-03 EVENT_FL 테이블에서 EVENT_NO 삭제
	   --BOARD 테이블에 BOARD_TITLE NOT NULL 제약조건 삭제

--2023-08-03 예약 테이블 게시판 테이블 수정사항 게시판 - 게시판 테이블에 예약 번호 참조

--KHOTEL ( 테이블 생성 + PRIMARY KEY + 시퀀스 )

grant create any job to semi_khj; -- 프로시저 사용하려면 사용자명에 자기꺼 넣기
...
-- 게시글 더미 데이터
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'공지사항 더미 데이터 1','공지사항 더미 데이터 1번 입니다. ㅋㅋ',DEFAULT,DEFAULT,1,1,NULL,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'공지사항 더미 데이터 2','공지사항 더미 데이터 2번 입니다. ㅎㅎ',DEFAULT,DEFAULT,1,1,NULL,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'공지사항 더미 데이터 3','공지사항 더미 데이터 3번 입니다. ^^',DEFAULT,DEFAULT,1,1,NULL,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'공지사항 더미 데이터 4','공지사항 더미 데이터 4번 입니다. ㅗㅗ',DEFAULT,DEFAULT,1,1,NULL,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'공지사항 더미 데이터 5','공지사항 더미 데이터 5번 입니다. ㅜㅜ',DEFAULT,DEFAULT,1,1,NULL,NULL);

-- FAQ 더미 데이터
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'FAQ 더미 데이터 1','FAQ 더미 데이터 1번 입니다. ㅋㅋ',DEFAULT,DEFAULT,4,1,NULL,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'FAQ 더미 데이터 2','FAQ 더미 데이터 2번 입니다. ㅋㅋ',DEFAULT,DEFAULT,4,1,NULL,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'FAQ 더미 데이터 3','FAQ 더미 데이터 3번 입니다. ㅋㅋ',DEFAULT,DEFAULT,4,1,NULL,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'FAQ 더미 데이터 4','FAQ 더미 데이터 4번 입니다. ㅋㅋ',DEFAULT,DEFAULT,4,1,NULL,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'FAQ 더미 데이터 5','FAQ 더미 데이터 5번 입니다. ㅋㅋ',DEFAULT,DEFAULT,4,1,NULL,NULL);

-- Q/A 더미 데이터
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'질문게시판 더미 데이터 1','질문게시판 더미 데이터 1번 입니다. ㅋㅋ',DEFAULT,DEFAULT,2,2,NULL,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'질문게시판 더미 데이터 2','질문게시판 더미 데이터 2번 입니다. ㅎㅎ',DEFAULT,DEFAULT,2,2,NULL,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'질문게시판 더미 데이터 3','질문게시판 더미 데이터 3번 입니다. ^^',DEFAULT,DEFAULT,2,2,NULL,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'질문게시판 더미 데이터 4','질문게시판 더미 데이터 4번 입니다. ㅗㅗ',DEFAULT,DEFAULT,2,2,NULL,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'질문게시판 더미 데이터 5','질문게시판 더미 데이터 5번 입니다. ㅜㅜ',DEFAULT,DEFAULT,2,2,NULL,NULL);

-- 리뷰 더미 데이터
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'리뷰 더미 데이터 1','리뷰 더미 데이터 1번 입니다. ㅋㅋ',DEFAULT,DEFAULT,3,2,1,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'리뷰 더미 데이터 2','리뷰 더미 데이터 2번 입니다. ㅎㅎ',DEFAULT,DEFAULT,3,2,2,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'리뷰 더미 데이터 3','리뷰 더미 데이터 3번 입니다. ^^',DEFAULT,DEFAULT,3,2,3,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'리뷰 더미 데이터 4','리뷰 더미 데이터 4번 입니다. ㅗㅗ',DEFAULT,DEFAULT,3,2,4,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'리뷰 더미 데이터 5','리뷰 더미 데이터 5번 입니다. ㅜㅜ',DEFAULT,DEFAULT,3,2,5,NULL);
INSERT INTO BOARD VALUES(SEQ_BOARD_NO.NEXTVAL,'리뷰 더미 데이터 5','리뷰 더미 데이터 6번 입니다. ㅜㅜ',DEFAULT,DEFAULT,3,2,NULL,NULL);

-- 댓글 더미 데이터 (Q/A 댓글)
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL,'7번 게시글의 더미 데이터 입니다.',DEFAULT,DEFAULT,2,12);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL,'8번 게시글의 더미 데이터 입니다.',DEFAULT,DEFAULT,2,13);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL,'9번 게시글의 더미 데이터 입니다.',DEFAULT,DEFAULT,2,14);
INSERT INTO REPLY VALUES(SEQ_REPLY_NO.NEXTVAL,'10번 게시글의 더미 데이터 입니다.',DEFAULT,DEFAULT,2,15);
...
INSERT INTO TAG VALUES('아이와 가기 좋아요',16,DEFAULT);
INSERT INTO TAG VALUES('조용해서 쉬기 좋아요',16,DEFAULT);
INSERT INTO TAG VALUES('침구가 고급스러워요',16,DEFAULT);
INSERT INTO TAG VALUES('애인과 가기 좋아요',16,DEFAULT);
INSERT INTO TAG VALUES('파티하기 좋아요',16,DEFAULT);

-- 신고 더미 데이터 
INSERT INTO REPORT VALUES(2,16,'몰라요 이상해요', DEFAULT);
...
INSERT INTO RESERVATION VALUES(SEQ_BOOK_NO.NEXTVAL,'2023-10-15','2023-10-19',2,DEFAULT,2,2);
INSERT INTO RESERVATION VALUES(SEQ_BOOK_NO.NEXTVAL,'2023-10-15','2023-10-19',2,DEFAULT,2,3);
INSERT INTO RESERVATION VALUES(SEQ_BOOK_NO.NEXTVAL,'2023-10-15','2023-10-19',2,DEFAULT,2,4);
INSERT INTO RESERVATION VALUES(SEQ_BOOK_NO.NEXTVAL,'2023-10-15','2023-10-19',2,DEFAULT,2,5);
INSERT INTO RESERVATION VALUES(SEQ_BOOK_NO.NEXTVAL,'2023-10-15','2023-10-19',2,DEFAULT,2,6);
INSERT INTO RESERVATION VALUES(SEQ_BOOK_NO.NEXTVAL,'2023-10-12','2023-10-14',2,DEFAULT,2,7);
INSERT INTO RESERVATION VALUES(SEQ_BOOK_NO.NEXTVAL,'2023-08-21','2023-08-23',4,'Y',4,1);
INSERT INTO RESERVATION VALUES(SEQ_BOOK_NO.NEXTVAL,'2023-09-21','2023-09-23',2,'Y',2,2);
INSERT INTO RESERVATION VALUES(SEQ_BOOK_NO.NEXTVAL,'2023-10-15','2023-10-16',3,'Y',3,3);
INSERT INTO RESERVATION VALUES(SEQ_BOOK_NO.NEXTVAL,'2023-11-08','2023-11-09',2,'Y',4,4);
...
--쿠폰 더미 데이터
INSERT INTO COUPON VALUES(SEQ_COUPON_NO.NEXTVAL,2,DEFAULT,30000,DEFAULT,DEFAULT);
INSERT INTO COUPON VALUES(SEQ_COUPON_NO.NEXTVAL,2,DEFAULT,30000,DEFAULT,DEFAULT);
INSERT INTO COUPON VALUES(SEQ_COUPON_NO.NEXTVAL,2,DEFAULT,30000,DEFAULT,DEFAULT);
INSERT INTO COUPON VALUES(SEQ_COUPON_NO.NEXTVAL,2,DEFAULT,30000,DEFAULT,DEFAULT);
INSERT INTO COUPON VALUES(SEQ_COUPON_NO.NEXTVAL,3,DEFAULT,30000,DEFAULT,DEFAULT);
INSERT INTO COUPON VALUES(SEQ_COUPON_NO.NEXTVAL,3,DEFAULT,30000,DEFAULT,DEFAULT);
INSERT INTO COUPON VALUES(SEQ_COUPON_NO.NEXTVAL,3,DEFAULT,30000,DEFAULT,DEFAULT);
INSERT INTO COUPON VALUES(SEQ_COUPON_NO.NEXTVAL,3,DEFAULT,30000,DEFAULT,DEFAULT);
