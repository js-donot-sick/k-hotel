                ...
                <main>
                    ...
                    <div class="J-BODY">
                        ...
                        <div class="J-BODY">
                            ...
                            <form accept="/review" method="post">
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="collapseOne" class="accordion-collapse "
                                                            ...
                                                            <div class="accordion-body">
                                                                ...
                                                                <div class="J-text">
                                                                    <input type="" placeholder="호텔지ㅈㅁ"
                                                                        value="${list.hotelName}" name="hotelName">
                                                                    <input type="" placeholder="객실명"
                                                                        value="${list.roomName}" name="roomName">
                                                                    <input type="" placeholder="체크인 날짜"
                                                                        value="${list.checkInTime}" name="checkIn">
                                                                    <input type="" placeholder="체크 아웃 날짜"
                                                                        value="${list.checkOutTime}" name="checkOut">
                                                                    <a href=""> <button id="J-btn">별점 / 리뷰작성</button>
                                                                    </a>
                                                                </div>
